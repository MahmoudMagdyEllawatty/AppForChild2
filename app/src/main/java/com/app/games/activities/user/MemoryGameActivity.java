...
public class MemoryGameActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startGame.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(difficulty == 0){
                    Toast.makeText(MemoryGameActivity.this, "Select Difficulty First", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                list.setLayoutManager(new GridLayoutManager(MemoryGameActivity.this
    ...
    private void selectDifficultyDialog(){
        ...
        View view = LayoutInflater.from(MemoryGameActivity.this)
                                    ...
                                    if(correctMemoryImages.size() == selectedMemoryImages.size()){
                                        ...
                                        builder.setMessage("Game Over! \n Your "+score.getText())
                                                ...
                                                .setPositiveButton("Go To Main", new DialogInterface.OnClickListener() {
                                                    @Override
                                                    public void onClick(DialogInterface dialog, int which) {
                                                        Intent intent = new Intent(MemoryGameActivity.this,
